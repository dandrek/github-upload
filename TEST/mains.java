...
public class mains {
    ...
    public static void main (String[] args) throws IOException{
        ...
        int age = 0;
        int choice = 20;
        ArrayList<Player> cpuPlayers = new ArrayList<Player>(8);
        ...
        while (runProgram) {
            ...
            for (int i = 0; i < 8; i ++) {
                ...
                cpuPlayers.add(new Player(acceleration,cpuAge,endurance,form,mental,speed,stamina,start,randomName()));
            }
            ...
            while (mainGame) {
                ...
                if (choice == 1) {
                    ...
                    for (int i = 0; i < 7; i++) {
                        ...
                        racers[i+1] = cpuPlayers.get(i);   
                        cpuRacers[i] = cpuPlayers.get(i);
                    }
                    ...
                    if (choice == 1) {
                        ...
                        race.oneHundredMetersRace(racers);
                    ...
                    if (choice == 2) {
                        ...
                        race.twoHundredMetersRace(racers);
                    ...
                    if (choice == 3) {
                        ...
                        race.fourHundredMetersRace(racers);
                    ...
                    System.out.println("Search the players name");
                    int playerNum = scnr.nextInt();                  

                    if (choice > cpuPlayers.size()) {
                        ...
                        System.out.println(cpuPlayers.get(playerNum));
                    }
                }
                    ...
                    System.out.println("Search the players name you want to compare to");
                    int playerNum = scnr.nextInt();
